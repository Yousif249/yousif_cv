  ...
  return (
    ...
    >
      ...
      {heroConfig.roles[0] && (
        ...
        >
          <div className="px-6 py-3 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl rotate-[-90deg] origin-left">
            <span className="text-[10px] font-geist-mono uppercase tracking-[0.4em] text-blue-400 font-bold whitespace-nowrap">
              {heroConfig.roles[0]}
            </span>
          </div>
        </div>
      ...
      {heroConfig.roles[1] && (
        ...
        >
          <div className="px-6 py-3 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl rotate-[90deg] origin-right">
            <span className="text-[10px] font-geist-mono uppercase tracking-[0.4em] text-blue-400 font-bold whitespace-nowrap">
              {heroConfig.roles[1]}
            </span>
          </div>
      ...
      {/* Content Container */}
      <div className="relative z-30 flex flex-col items-center justify-end min-h-screen px-6 lg:px-12 pb-20 pointer-events-none">
        ...
        >
          <div className="relative inline-block px-12 py-6 bg-black/20 backdrop-blur-sm rounded-[3rem] border border-white/5">
            <h1 className="text-[clamp(3rem,10vw,10rem)] font-black text-white tracking-[-0.04em] leading-[0.85] uppercase">
              {heroConfig.name}
            </h1>
